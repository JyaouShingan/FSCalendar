...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _headerButtonsColor = FSCalendarStandardTitleTextColor;
...
- (void)setHeaderButtonsColor:(UIColor *)color
{
    if (![_headerButtonsColor isEqual:color]) {
        _headerButtonsColor = color;
        [self.calendar configureAppearance];
    }
}
